...
import { Avatar, List, Space, Grid } from 'antd';
...
const SocialPoliticsPage = () => {
    const { handleClickSocialPolitics, socialPolitics } = useDataContext();
    return (
        <>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-12">
                            <List
                                ...
                                dataSource={socialPolitics.slice(4)}
                                renderItem={(item) => (
                                    <List.Item key={item.title}>
                                        <div class="utf_post_block_style post-grid clearfix">
                                            ...
                                            <a class="utf_post_cat" href="#">Chính trị-xã hội</a>
                                            <div class="utf_post_content">
                                                <h2 class="utf_post_title title-large">
                                                    <a onClick={() => handleClickSocialPolitics(item.title)}>{item.title}</a>
                                                </h2>
                                                <p onClick={() => handleClickSocialPolitics(item.title)}>{shortenTitle(item.p)}</p>
                                            </div>
                                        </div>
                                    </List.Item>
                                )}
                                ...
                                <div class="widget color-default">
                                    ...
                                    <div class="utf_list_post_block">
                                        <ul class="utf_list_post">
                                            {
                                                socialPolitics.slice(0, 4).map((item, index) => (
                                                    <li class="clearfix">
                                                        <div class="utf_post_block_style post-float clearfix">
                                                            ...
                                                            <div class="utf_post_content">
                                                                <h2 class="utf_post_title title-small"> <a onClick={() => handleClickSocialPolitics(item.title)}>{item.title}</a> </h2>
