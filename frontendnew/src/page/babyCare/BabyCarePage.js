...
const BabyCarePage = () => {
    const { handleClickBabyCare, babyCare } = useDataContext();
    return (
                            ...
                            renderItem={(item) => (
                                <List.Item key={item.title}>
                                    <div class="utf_post_block_style post-grid clearfix">
                                        ...
                                        <a class="utf_post_cat" href="#">chăm sóc trẻ</a>
                                        <div class="utf_post_content">
                                            <h2 class="utf_post_title title-large">
                                                <a onClick={() => handleClickBabyCare(item.title)}>{item.title}</a>
                                            </h2>
                                            <p onClick={() => handleClickBabyCare(item.title)}>{shortenTitle(item.p)}</p>
                                        </div>
                                    </div>
                                </List.Item>
                            )}
                            ...
                            <div class="widget color-default">
                                ...
                                <div class="utf_list_post_block">
                                    <ul class="utf_list_post">
                                        {
                                            babyCare.slice(0, 4).map((item, index) => (
                                                <li class="clearfix">
                                                    <div class="utf_post_block_style post-float clearfix">
                                                        <div class="utf_post_thumb"> <a href="#"> <img class="img-fluid" src={item.image_url} alt="" /> </a> <a class="utf_post_cat" href="#">Chăm sóc trẻ</a> </div>
                                                        <div class="utf_post_content">
                                                            <h2 class="utf_post_title title-small"> <a onClick={() => handleClickBabyCare(item.title)}>{item.title}</a> </h2>
