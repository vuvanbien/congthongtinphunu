...
const FamilyPage = () => {
    const { handleClickFamily, family } = useDataContext();
    return (
                                    ...
                                    <div class="utf_post_block_style post-grid clearfix">
                                        ...
                                        <div class="utf_post_content">
                                            <h2 class="utf_post_title title-large">
                                                <a onClick={() => handleClickFamily(item.title)}>{item.title}</a>
                                            </h2>
                                            <p onClick={() => handleClickFamily(item.title)}>{shortenTitle(item.p)}</p>
                                        </div>
                                    </div>
                                </List.Item>
                            )}
                            ...
                            <div class="widget color-default">
                                ...
                                <div class="utf_list_post_block">
                                    <ul class="utf_list_post">
                                        {
                                            family.slice(0, 4).map((item, index) => (
                                                <li class="clearfix">
                                                    <div class="utf_post_block_style post-float clearfix">
                                                        ...
                                                        <div class="utf_post_content">
                                                            <h2 class="utf_post_title title-small"> <a onClick={() => handleClickFamily(item.title)}>{item.title}</a> </h2>
