...
const IndexPage = () => {
    const { handleClick, data } = useDataContext();
    return (
                                    ...
                                    <div class="utf_post_block_style post-grid clearfix">
                                        ...
                                        <div class="utf_post_content">
                                            <h2 class="utf_post_title title-large">
                                                <a onClick={() => handleClick(item.title)}>{shortenTitle(item.title)}</a>
                                            </h2>
                                            <p onClick={() => handleClick(item.title)}>{shortenTitle(item.p)}</p>
                                        </div>
                                    </div>
                                </List.Item>
                            )}
                                            ...
                                            data.slice(0, 4).map((item, index) => (
                                                <li class="clearfix">
                                                    <div class="utf_post_block_style post-float clearfix">
                                                        ...
                                                        <div class="utf_post_content">
                                                            <h2 class="utf_post_title title-small"> <a onClick={() => handleClick(item.title)}>{item.title}</a> </h2>
